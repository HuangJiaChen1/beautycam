...
left_cheek = [132,58,172, 136, 150, 149, 176]
right_cheek = [361,288,397, 365, 379, 378, 400]
...
def zhailian(ZHAILIAN, dst_points):
    left_cheek_points = get_points_3D(dst_points, left_cheek)
    right_cheek_points = get_points_3D(dst_points, right_cheek)


    new_cheek_points = calc_slim_points(left_cheek_points, right_cheek_points, ZHAILIAN)
    # print(len(new_cheek_points))
    i = 0
